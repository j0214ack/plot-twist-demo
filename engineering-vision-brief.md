...
>
> 下一步，我們只預製角色、場景和關鍵劇情骨架。玩家觀看上一幕時，系統預測幾個最可能的下一步，提前生成候選鏡頭，最後只接上玩家真正走到的未來。再下一步，文字也不再是唯一介面：你可以點擊手機、走向門口、避開他的眼神，甚至直接開口；這些行為都會改變角色知道的事、彼此的關係，以及下一幕。
>
